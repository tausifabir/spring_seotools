...
public class DuplicatedJavascript {
    ...
    private DuplicatedJavascriptDetails details;
    ...
    public DuplicatedJavascriptDetails getDetails() { return details; }
    @JsonProperty("details")
    public void setDetails(DuplicatedJavascriptDetails value) { this.details = value; }
