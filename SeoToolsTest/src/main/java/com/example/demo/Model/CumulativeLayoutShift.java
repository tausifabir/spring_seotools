...
public class CumulativeLayoutShift {
    ...
    private CumulativeLayoutShiftDetails details;
    ...
    public CumulativeLayoutShiftDetails getDetails() { return details; }
    @JsonProperty("details")
    public void setDetails(CumulativeLayoutShiftDetails value) { this.details = value; }
